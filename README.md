...
- 객체지향이 주목받던 초기에는 상속이 다형성을 구현할 수 있는 거의 유일한 방법이었지만 최근의 언어들은 상속 외에도 다형성을 구현할 수 있는 다양한 방법을 제공하고 있기 때문에 상속의 중요성이 많이 낮아짐

### 12.1 다형성

- 다형성은 여러 타입을 대상으로 동작할 수 있는 코드를 작성할 수 있는 방법이라 할 수 있다.
